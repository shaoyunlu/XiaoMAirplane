...
(function () {
  ...
  function changeProtocolAndHost(url, newProtocolAndHost) {
    const regex = /^(https?:\/\/)[^/]+/;
    return url.replace(regex, newProtocolAndHost);
  }
    ...
    //if (hasDocument && document.readyState === 'loading' && typeof deps !== 'string') {
      ...
      if (lastScript) {
        ...
        if (window.xmAirplaneGetCurrentApp){
          lastScript.src = changeProtocolAndHost(lastScript.src, window.xmAirplaneGetCurrentApp().pageEntry);
        }
